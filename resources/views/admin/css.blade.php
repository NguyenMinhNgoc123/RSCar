...
<!-- Ionicons -->
<link rel="stylesheet"
      href="{{asset('/AdminLTE-master/https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css')}}">
<!-- Tempusdominus Bootstrap 4 -->
<link rel="stylesheet"
      href="{{asset('/AdminLTE-plugins/fontawesome-free/css/all.min.cssmaster/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
<!-- iCheck -->
