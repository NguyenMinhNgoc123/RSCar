    ...
    <div class="footer-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-4">
                    <div class="payment-accept"> <img src="{{('/backend/images/payment-1.png')}}" alt=""> <img src="{{('/backend/images/payment-2.png')}}" alt=""> <img src="{{('public/backend/images/payment-3.png')}}" alt=""> <img src="{{('public/backend/images/payment-4.png')}}" alt=""> </div>
                </div>
            </div>
        </div>
    </div>
