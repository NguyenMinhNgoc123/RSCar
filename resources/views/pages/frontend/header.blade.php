                ...
                <div class="header-container">
                    ...
                    <div class="header__nav">
                        <div class="header-banner">
                            ...
                            <div class="col-lg-6 col-lg-6 col-xs-12 col-sm-6 col-md-6 call-us"><i class="fa fa-clock-o"></i> Mon - Fri : 09am to 06pm <i class="fa fa-phone"></i> 0815115415</div>
                        </div>
                                    ...
                                    <div class="fl-nav-links">
                                        <div class="language-currency">
                                            <div class="fl-language">
                                                <h3>Language</h3>
                                                <ul class="lang">
                                                    <li><a href="#"> <img src="{{('/backend/images/english.png')}}" alt="English"> <span>English</span> </a></li>
                                                    <li><a href="#"> <img src="{{('/backend/images/francais.png')}}" alt="French"> <span>French</span> </a></li>
                                                    <li><a href="#"> <img src="{{('/backend/images/german.png')}}" alt="German"> <span>German</span> </a></li>
                                                </ul>
                                            </div>
                                            <!--fl-language-->
                                ...
                                <div class="mini-cart">
                                    ...
                                    <div class="fl-mini-cart-content" style="display: none;">
                                        ...
                                        <ul class="mini-products-list" id="cart-sidebar">
                                            <li class="item first">
                                                <div class="item-inner"><a class="product-image" title="timi &amp; leslie Sophia Diaper Bag, Lemon Yellow/Shadow White" href="#l"><img alt="timi &amp; leslie Sophia Diaper Bag, Lemon Yellow/Shadow White" src="{{('/backend/products-images/p4.jpg')}}"></a>
                                            ...
                                            <li class="item last">
                                                <div class="item-inner"><a class="product-image" title="JP Lizzy Satchel Designer Diaper Bag - Slate Citron" href="#"><img alt="JP Lizzy Satchel Designer Diaper Bag - Slate Citron" src="{{('/backend/products-images/p3.jpg')}}"></a>
                                                    <div class="product-details">
                                                        <div class="access"><a class="btn-remove1" title="Remove This Item" href="#">Remove</a> <a class="btn-edit" title="Edit item" href="#"><i class="icon-pencil"></i><span class="hidden">Edit item</span></a> </div>
                                                        <!--access-->
                            ...
                            <nav>
                                ...
                                <div class="nav-inner">
                                    ...
                                    <ul id="nav" class="hidden-xs">
                                        <li class="active"> <a class="level-top" href="{{route('index')}}"><span>Trang chủ</span></a></li>
                                        <li class="mega-menu"> <a class="level-top" href="grid1.html"><span>Phụ Tùng</span></a>
                                        ...
                                        <li class="level0 parent drop-menu"> <a class="level-top" href="{{route('list')}}"><span>Sản phẩm</span></a>
                                            <ul class="level1">
                                        ...
                                        <li class="fl-custom-tabmenulink mega-menu"> <a href="#" class="level-top"> <span>Chương trình quảng cáo</span> </a>
                                            <div class="level0-wrapper fl-custom-tabmenu" style="left: 0px; display: none;">
                                                <div class="container">
                                                    <div class="header-nav-dropdown-wrapper clearer">
                                                        <div class="grid12-3">
                                                            <div><img src="{{('/backend/images/custom-img1.jpg')}}" alt="custom-image"></div>
                                                            <h4 class="heading">SALE UP TO 30% OFF</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                        </div>
                                                        <div class="grid12-3">
                                                            <div><img src="{{('/backend/images/custom-img2.jpg')}}" alt="custom-image"></div>
                                                            <h4 class="heading">SALE UP TO 30% OFF</h4>
                                                            <p>Sed et quam lacus. Fusce condimentum eleifend enim a feugiat.</p>
                                                        </div>
                                                        <div class="grid12-3">
                                                            <div><img src="{{('/backend/images/custom-img3.jpg')}}" alt="custom-image"></div>
                                                            <h4 class="heading">SALE UP TO 30% OFF</h4>
                                                            <p>Sed et quam lacus. Fusce condimentum eleifend enim a feugiat.</p>
                                                        </div>
                                                        <div class="grid12-3">
                                                            <div><img src="{{('/backend/images/custom-img4.jpg')}}" alt="custom-image"></div>
                                                            <h4 class="heading">SALE UP TO 30% OFF</h4>
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                                        </div>
                                                    </div>
