                            ...
                            <table id="shopping-cart-table" class="data-table cart-table table-striped">
                                ...
                                <tr class="first last odd">
                                    <td class="image hidden-table"><a href="product-detail.html"
                                                ...
                                                src="products-images/p8.jpg" width="75"
                    ...
                    <span class="cart-price">
                                ...
                                <tr class="odd">
                                    <td class="image hidden-table"><a href="product-detail.html"
                                                                      title="Women&#39;s Georgette Animal Print"
                                                                      class="product-image"><img
                                                src="products-images/p3.jpg" width="75"
                                                alt="Women&#39;s Georgette Animal Print"></a></td>
                                    <td>
                                        <h2 class="product-name">
                                            <a href="product-detail.html">Women's Georgette Animal Print</a>
                    ...
                    <span class="cart-price">
                                ...
                                <tr class="odd">
                                    <td class="image hidden-table"><a href="product-detail.html"
                                                                      title="Women&#39;s Georgette Animal Print"
                                                                      class="product-image"><img
                                                src="products-images/p1.jpg" width="75"
                                                alt="Women&#39;s Georgette Animal Print"></a></td>
                                    <td>
                                        <h2 class="product-name">
                                            <a href="product-detail.html">Women's Georgette Animal Print</a>
                    ...
                    <span class="cart-price">
                                ...
                                <tr class="last">
                                    <td class="image hidden-table"><a href="product-detail.html"
                                                                      title="Women&#39;s Georgette Animal Print"
                                                                      class="product-image"><img
                                                src="products-images/p9.jpg" width="75"
                                                alt="Women&#39;s Georgette Animal Print"></a></td>
                                    <td>
                                        <h2 class="product-name">
                                            <a href="product-detail.html">Women's Georgette Animal Print</a>
                                ...
                                <form action="#" method="post" id="shipping-zip-form">
                                        ...
                                        <li>
                                            ...
                                            <div class="input-box">
                                                <select id="region_id" name="region_id" title="State/Province"
                                                    ...
                                                    <option value="6" title="Armed Forces Africa">Armed Forces Africa
                                                    </option>
                                                    <option value="7" title="Armed Forces Americas">Armed Forces
                                                        Americas
                                                    </option>
                                                    <option value="8" title="Armed Forces Canada">Armed Forces Canada
                                                    </option>
                                                    <option value="9" title="Armed Forces Europe">Armed Forces Europe
                                                    </option>
                                                    ...
                                                    <option value="46" title="Northern Mariana Islands">Northern Mariana
                                                        Islands
                                                    </option>
                                    ...
                                    <div class="buttons-set11">
                                        <button type="button" title="Get a Quote"
                                                onClick="coShippingMethodForm.submit()" class="button get-quote"><span>Get a Quote</span>
                                        </button>
                                    </div> <!--buttons-set11-->
                                </form>
