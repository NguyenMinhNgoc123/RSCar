        ...
        <ol  onLoad="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="" class="one-page-checkout" id="checkoutSteps">
            <li id="opc-billing" class="section allow active">
                <div class="step-title"><span class="number">1</span>
                    <h3 class="one_page_heading">NHẬP EMAIL ĐÃ ĐĂNG KÝ</h3>
                </div>
                <div id="checkout-step-billing" class="step a-item">
                    <form id="co-billing-form" action="{{route('guest.check-email')}}" method="post">
                        @csrf
                                ...
                                <li id="billing-new-address-form">
                                    <fieldset>
                                        <ul>
                                            <li class="fields">
                                                <div class="input-box">
                                                    <label for="billing:city">Email :<em
                                                            class="required">*</em></label>
                                                    <input type="email" title="City" name="email"
